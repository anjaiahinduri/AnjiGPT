...
AnjiGPT is an open-source **agentic AI chatbot** built with **Python, FastAPI, LangGraph, LangChain, Google Gemini, Tavily, ChromaDB, and SQLite**.
...
```bash
git clone https://github.com/anjaiahinduri/AnjiGPT.git
```
...
```bash
conda create -n anjigpt python=3.11 -y
```

### 4. Activate the virtual environment

```bash
conda activate anjigpt
```
...
```text
123456789123.dkr.ecr.us-east-1.amazonaws.com/anjigpt
```
